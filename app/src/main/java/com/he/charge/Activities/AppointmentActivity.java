...
public class AppointmentActivity extends Activity implements LocationSource,AMapLocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button_toAppoint.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "请选择一个充电桩", Toast.LENGTH_SHORT).show();
            }
        });
